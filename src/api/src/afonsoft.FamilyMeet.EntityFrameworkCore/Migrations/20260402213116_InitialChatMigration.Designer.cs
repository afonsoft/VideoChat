...
{
    [DbContext(typeof(FamilyMeetDbContext))]
    [Migration("20260402213116_InitialChatMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("afonsoft.FamilyMeet.Chat.ChatGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppChatChatGroups", (string)null);
                });

            modelBuilder.Entity("afonsoft.FamilyMeet.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChatGroupId", "CreationTime");

                    b.HasIndex("ChatGroupId", "IsDeleted", "CreationTime");

                    b.ToTable("AppChatChatMessages", (string)null);
                });

            modelBuilder.Entity("afonsoft.FamilyMeet.Chat.ChatParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppChatChatParticipants", (string)null);
                });
            ...
            modelBuilder.Entity("afonsoft.FamilyMeet.Chat.ChatMessage", b =>
                {
                    b.HasOne("afonsoft.FamilyMeet.Chat.ChatGroup", null)
                        .WithMany()
                        .HasForeignKey("ChatGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("afonsoft.FamilyMeet.Chat.ChatMessage", null)
                        .WithMany()
