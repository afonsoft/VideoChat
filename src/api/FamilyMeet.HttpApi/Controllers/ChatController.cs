...
public class ChatController : ControllerBase
{
    ...
    [HttpPost("groups")]
    public async Task<ActionResult<FamilyMeetGroupDto>> CreateGroup([FromBody] CreateChatGroupDto input)
    {
        try
        {
    ...
    [HttpGet("groups/{id}")]
    public async Task<ActionResult<FamilyMeetGroupDto>> GetGroup(Guid id)
    {
        try
        {
    ...
    [HttpPut("groups/{id}")]
    public async Task<ActionResult<FamilyMeetGroupDto>> UpdateGroup(Guid id, [FromBody] UpdateChatGroupDto input)
    {
        try
        {
    ...
    public async Task<ActionResult<List<FamilyMeetGroupDto>>> GetUserGroups(Guid userId)
    {
        try
        {
    ...
    public async Task<ActionResult<FamilyMeetGroupDto>> JoinGroup([FromBody] JoinGroupDto input)
    {
        try
        {
