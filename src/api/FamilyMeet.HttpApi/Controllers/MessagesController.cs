...
public class MessagesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<FamilyMeetMessageDto>> SendMessage([FromBody] SendMessageDto input)
    {
        try
        {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<FamilyMeetMessageDto>> GetMessage(Guid id)
    {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<FamilyMeetMessageDto>> EditMessage(Guid id, [FromBody] EditMessageDto input)
    {
        try
        {
