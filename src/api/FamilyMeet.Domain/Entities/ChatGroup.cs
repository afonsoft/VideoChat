...
public class ChatGroup
{
    ...
    public ChatGroup()
    {
        ...
        IsActive = true;
        MaxParticipants = FamilyMeetConsts.MaxVideoCallParticipants;
    }

    public ChatGroup(string name, string description, GroupType type, Guid creatorId, int maxParticipants = FamilyMeetConsts.MaxVideoCallParticipants)
        : this()
    {
        Name = name;
    ...
    public void UpdateName(string name)
    {
        ...
        if (name.Length > FamilyMeetConsts.MaxGroupNameLength)
            throw new ArgumentException($"Group name cannot exceed {FamilyMeetConsts.MaxGroupNameLength} characters", nameof(name));
