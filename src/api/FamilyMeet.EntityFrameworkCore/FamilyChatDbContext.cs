...
public class FamilyMeetDbContext : AbpDbContext<FamilyMeetDbContext>
{
    ...
    public async Task SeedDataAsync()
    {
        ...
        {
            new ChatMessage("Olá pessoal! Sejam bem-vindos ao FamilyMeet! 🎉", userId, "Usuário Demo", generalGroup.Id, MessageType.System),
