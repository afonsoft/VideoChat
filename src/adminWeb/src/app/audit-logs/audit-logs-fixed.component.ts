...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <div class="results" *ngIf="auditLogs.length > 0">
          ...
          <table class="audit-table">
            ...
            <tbody>
              <tr *ngFor="let log of auditLogs">
                ...
                <td>{{ log.message }}</td>
                <td>
                  <span class="log-level log-level-{{ log.logLevel | lowercase }}">
                    {{ log.logLevel }}
                  </span>
                </td>
      ...
      <div class="no-results" *ngIf="auditLogs.length === 0 && !loading">
...
export class AuditLogsComponent implements OnInit {
  templateUrl: './audit-logs-fixed.component.html',
  auditLogs: any[] = [];
  loading = false;
  currentPage = 0;
  totalPages = 0;
